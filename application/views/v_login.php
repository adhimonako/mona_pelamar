            ...
            <form method="post" action="<?php echo base_url(); ?>login" role="form">
                <div class="body bg-gray">
                    ...
                    <div class="form-group has-error">
                        <label class="control-label" for="nm_user"><?php echo form_error("nm_user");?></label>
                        <input id="nm_user" type="text" name="nm_user" class="form-control" placeholder="Username"/>
                    </div>
                    <div class="form-group has-error">
                        <label class="control-label" for="pass_user"><?php echo form_error("pass_user");?></label>
