...
<div class="box box-succesful">
    ...
    <div class="box-body">
        ...
        <form role="form" method="post" action="<?php echo base_url();?>pelamar/edit/<?php echo $row['pelamar_id'];?>">
            <!-- text input -->
            <div class="form-group">
                <label>Nama</label>
                <input type="text" name="pelamar_nama" class="form-control"  value="<?php echo $row['pelamar_nama'];?>"/>
            </div>
            <div class="form-group">
                <label>Tempat Lahir</label>
                <input  type="text" name="pelamar_tmp_lahir" class="form-control"  value="<?php echo $row['pelamar_tmp_lahir'];?>"/>
            </div>
            <div class="form-group">
                <label>Tanggal Lahir</label>
                <input id="tgl_lahir" type="text" name="pelamar_tgl_lahir" class="form-control datepicker"  value="<?php echo $row['pelamar_tgl_lahir'];?>"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Status</label>
                <input type="text" name="pelamar_status" class="form-control"  />
            </div>
            <div class="form-group">
